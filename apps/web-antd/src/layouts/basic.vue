...
import {
  FilePreview,
  ImagePreview,
  registerFilePreviewInstance,
  registerImagePreviewInstance,
...
onMounted(() => {
  ...
  // 注册ImagePreview实例
  registerImagePreviewInstance(imagePreviewRef.value);
  // 注册FilePreview实例
  registerFilePreviewInstance(filePreviewRef.value);
});
