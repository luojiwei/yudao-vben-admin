...
import OtherDeviceForm from './OtherDeviceForm.vue';
...
const [FormModal, formModalApi] = useVbenModal({
  connectedComponent: OtherDeviceForm,
  destroyOnClose: true,
});
...
const getGridColumns = () => {
  const columns = [
    ...
    },
    {
      ...
      cellRender: {
        name: 'CellDict',
        props: { type: DICT_TYPE.ESTATE_DEVICE_OTHER_TYPE },
      },
    },
    {
      field: 'deviceModel',
...
<template>
  <div class="module-grid other-device-list">
